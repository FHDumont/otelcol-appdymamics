...
# Start Machine Agent
# ${MACHINE_AGENT_HOME}/bin/machine-agent -Dmetric.http.listener=true
# -d -p ${MACHINE_AGENT_HOME}/pidfile

java -Dmetric.http.listener=true -Dmetric.http.listener.port=8293 -Dmetric.http.listener.host=0.0.0.0 -jar ${MACHINE_AGENT_HOME}/machineagent.jar
